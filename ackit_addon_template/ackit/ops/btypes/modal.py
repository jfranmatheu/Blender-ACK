...
# from ...flags import ModalFlags  # commented to fix circular import error
...
class Modal(ModalCursor, Generic):
    ...
    def _start_drawing(self, context: Context) -> None:
        if self._modal_flags is None:
            return
        # Import locally to avoid potential circular dependencies at module load time
        from ...flags import MODAL as ModalFlags
